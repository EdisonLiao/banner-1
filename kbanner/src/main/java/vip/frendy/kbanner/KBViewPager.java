 ...
 */
public class KBViewPager extends ViewPager {
    ...
    public KBViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setPageChangeDuration(int duration) {
        try {
            ...
            scrollerField.set(this, new KBBannerScroller(getContext(), duration));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
